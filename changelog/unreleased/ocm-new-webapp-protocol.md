...
- The SQL share manager persists the new webapp fields; note that the
  permissions column of pre-existing webapp rows was stored as a view
  mode enum and should be remapped to OCS permission bits (1,2,4 -> 1
  and 3 -> 15) when upgrading
