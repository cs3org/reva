...
points, each with the base URI it reports fixed at declaration. What is left of
the walk is one segment read per subtree, for the user, space, share or token
its URL carries.
