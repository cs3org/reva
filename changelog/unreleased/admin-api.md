...
request or user across the fleet, adjust a process's log level at runtime, take
instances out of (and back into) rotation for maintenance, watch an instance's
in-flight request activity to know when it has quiesced, and impersonate a user. Services expose those operations over a small control channel
