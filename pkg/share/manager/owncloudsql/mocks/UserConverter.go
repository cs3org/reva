...
// NewUserConverter creates a new instance of UserConverter. It also registers a cleanup function to assert the mocks expectations.
func NewUserConverter(t testing.TB) *UserConverter {
	mock := &UserConverter{}
