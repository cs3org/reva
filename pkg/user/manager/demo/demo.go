...
type manager struct {
	catalog map[string]*userproviderv0alphapb.User
}
...
func getUsers() map[string]*userproviderv0alphapb.User {
	return map[string]*userproviderv0alphapb.User{
		"4c510ada-c86b-4815-8820-42cdf82c3d51": &userproviderv0alphapb.User{
			Id: &typespb.UserId{
		...
		"f7fbf8c8-139b-4376-b307-cf0a8c2d0d9c": &userproviderv0alphapb.User{
			Id: &typespb.UserId{
				Idp:      "http://localhost:9998",
		...
		"932b4540-8d16-481e-8ef4-588e4b6b151c": &userproviderv0alphapb.User{
			Id: &typespb.UserId{
				Idp:      "http://localhost:9998",
