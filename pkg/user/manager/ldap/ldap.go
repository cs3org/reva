...
func (m *manager) GetUser(ctx context.Context, uid *userpb.UserId) (*userpb.User, error) {
	...
	userEntry, err := m.getLDAPUserByFilter(ctx, l, m.getUserFilter(uid))
	if err != nil {
		return nil, err
	}
...
func (m *manager) GetUserByClaim(ctx context.Context, claim, value string) (*userpb.User, error) {
	...
	userEntry, err := m.getLDAPUserByFilter(ctx, l, m.getAttributeFilter(claim, value))
	if err != nil {
		return nil, err
	}
	log.Debug().Interface("entry", userEntry).Msg("entry")
...
func (m *manager) getLDAPUserByFilter(ctx context.Context, conn *ldap.Conn, filter string) (*ldap.Entry, error) {
	log := appctx.GetLogger(ctx)
