...
func (m *manager) parseAndCacheUser(ctx context.Context, userData *userData) (*userpb.User, error) {
	var mail, name string
	if userData.PrimaryAccountEmail != nil {
	...
	u := &userpb.User{
		...
		Mail:        mail,
		DisplayName: name,
		UidNumber:   userData.UID,
		GidNumber:   userData.Gid,
	}
...
func (m *manager) GetUserGroups(ctx context.Context, uid *userpb.UserId) ([]string, error) {
	...
	groups = make([]string, 0, len(result.Data))
