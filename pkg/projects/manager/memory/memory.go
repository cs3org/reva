...
func (s *service) ListStorageSpaces(ctx context.Context, req *provider.ListStorageSpacesRequest, status projects.ProjectStatus) (*provider.ListStorageSpacesResponse, error) {
