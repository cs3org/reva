...
// PurgeRecycleItemFunc provides a mock function with given fields: ctx, key, purgePath
func (_m *Tree) PurgeRecycleItemFunc(ctx context.Context, key string, purgePath string) (*node.Node, func() error, error) {
	ret := _m.Called(ctx, key, purgePath)

	var r0 *node.Node
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *node.Node); ok {
		r0 = rf(ctx, key, purgePath)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*node.Node)
		}
	...
	var r1 func() error
	if rf, ok := ret.Get(1).(func(context.Context, string, string) func() error); ok {
		r1 = rf(ctx, key, purgePath)
	} else {
		if ret.Get(1) != nil {
...
// RestoreRecycleItemFunc provides a mock function with given fields: ctx, key, trashPath, restorePath
func (_m *Tree) RestoreRecycleItemFunc(ctx context.Context, key string, trashPath string, restorePath string) (*node.Node, *node.Node, func() error, error) {
	ret := _m.Called(ctx, key, trashPath, restorePath)

	var r0 *node.Node
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) *node.Node); ok {
		r0 = rf(ctx, key, trashPath, restorePath)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*node.Node)
		}
	...
	var r1 *node.Node
	if rf, ok := ret.Get(1).(func(context.Context, string, string, string) *node.Node); ok {
		r1 = rf(ctx, key, trashPath, restorePath)
	} else {
		if ret.Get(1) != nil {
	...
	var r2 func() error
	if rf, ok := ret.Get(2).(func(context.Context, string, string, string) func() error); ok {
		r2 = rf(ctx, key, trashPath, restorePath)
	} else {
		if ret.Get(2) != nil {
	...
	if rf, ok := ret.Get(3).(func(context.Context, string, string, string) error); ok {
		r3 = rf(ctx, key, trashPath, restorePath)
	} else {
		r3 = ret.Error(3)
	}
...
// Setup provides a mock function with given fields: owner, propagateToRoot
func (_m *Tree) Setup(owner *userv1beta1.UserId, propagateToRoot bool) error {
	ret := _m.Called(owner, propagateToRoot)

	var r0 error
	if rf, ok := ret.Get(0).(func(*userv1beta1.UserId, bool) error); ok {
		r0 = rf(owner, propagateToRoot)
	} else {
		r0 = ret.Error(0)
	}
