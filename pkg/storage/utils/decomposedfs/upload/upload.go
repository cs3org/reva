...
func validateRequest(ctx context.Context, size int64, uploadMetadata tus.Session, n *node.Node) error {
...
func ReadNode(ctx context.Context, lu *lookup.Lookup, uploadMetadata tus.Session) (*node.Node, error) {
	var n *node.Node
	var err error
