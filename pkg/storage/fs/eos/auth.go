...
// Returns an authorization that maps to nobody,
// to represent invalid authorizations in case of errors
func invalidAuth() eosclient.Authorization {
	return eosclient.Authorization{
		Role: eosclient.NobodyRole(),
	}
}
