...
// shared builds a model.Share with the fields the shallow job reads.
func shared(id uint, space, inode, shareWith string, isGroup bool, perms uint8) model.Share {
