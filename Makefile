...
deps:
	cd /tmp && rm -rf golangci-lint &&  git clone --quiet -b 'v1.45.2' --single-branch --depth 1 https://github.com/golangci/golangci-lint &> /dev/null && cd golangci-lint/cmd/golangci-lint && go install
