...
renaming file/folder doesn't changes the etag of parent <br/>
moving a file/folder from one folder to another doesn't changes etag of destination folder <br/>
renaming a file/folder inside another folder doesn't changes etag of parent folder <br/>
