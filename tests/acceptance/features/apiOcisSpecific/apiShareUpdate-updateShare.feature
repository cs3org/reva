...
Feature: sharing
  ...
  @skipOnOcis-OC-Storage @skipOnOcis-OCIS-Storage @issue-ocis-reva-243
  ...
  @skipOnOcis-OCIS-Storage @issue-ocis-reva-243 @issue-ocis-reva-349 @issue-ocis-reva-350 @issue-ocis-reva-352 @issue-37653
  # after fixing all issues delete this Scenario and use the one from oC10 core
