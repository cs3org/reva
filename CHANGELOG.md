Changelog for reva 3.12.1 (2026-07-31)
=======================================

The following sections list the changes in reva 3.12.1 relevant to
reva users. The changes are ordered by importance.

Summary
-------

 * Fix #5739: Expose the grantee type in share notifications

Details
-------

 * Bugfix #5739: Expose the grantee type in share notifications

   https://github.com/cs3org/reva/pull/5739
 ...
 * Bugfix #5702: Preserve child ACLs when creating parent shares
   ...
   https://github.com/cs3org/reva/pull/5702
 ...
 * Bugfix #5686: Do not fail list shares if only OCM shares fail to be retrieved
   ...
   https://github.com/cs3org/reva/pull/5686

 * Bugfix #5687: Set resource id properly in share creation

   https://github.com/cs3org/reva/pull/5687
 ...
 * Enhancement #5641: Make addSpaceInfo more defensive
   ...
   https://github.com/cs3org/reva/pull/5641

 * Enhancement #5640: Remove useless, spammy log line

   https://github.com/cs3org/reva/pull/5640
 ...
 * Enhancement #5597: Proper passthrough of EOS ACL errors
   ...
   https://github.com/cs3org/reva/pull/5597
 ...
 * Bugfix #5585: Fix failure on version download
   ...
   https://github.com/cs3org/reva/pull/5585
 ...
 * Enh #5504: Cephmount filesystem to mds mapping
 ...
 * Enhancement #5504: Cephmount filesystem to mds mapping

   * In our testing environment any active MDS was usable, however on the doyle cluster this is not
   the case, and we need to find the active MDS corresponding to our filesystem (in this case
   cephfs). * The filesystem is a configurable option in the Reva driver.
