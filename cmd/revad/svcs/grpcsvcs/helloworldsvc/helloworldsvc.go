...
import (
	...
	"github.com/cs3org/reva/cmd/revad/svcs/grpcsvcs/helloworldsvc/proto"
...
func init() {
	grpcserver.Register("helloworldsvc", New)
}
...
func New(m map[string]interface{}, ss *grpc.Server) (io.Closer, error) {
	...
	if err := mapstructure.Decode(m, c); err != nil {
		err = errors.Wrap(err, "helloworldsvc: error decoding conf")
		return nil, err
	}
