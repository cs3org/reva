...
// this file is a fork of https://github.com/tus/tusd/tree/master/pkg/handler/unrouted_handler.go
// TODO remove when PRs have been merged upstream
// - https://github.com/tus/tusd/pull/309
...
func (handler *UnroutedHandler) lockUpload(id string) (tusd.Lock, error) {
