...
func (s *svc) getClient() (gatewayv1beta1pb.GatewayServiceClient, error) {
	return pool.GetGatewayServiceClient(s.c.GatewaySvc)
}

func wrapResourceID(r *storageproviderv1beta1pb.ResourceId) string {
...
func unwrap(rid string) *storageproviderv1beta1pb.ResourceId {
	...
	return &storageproviderv1beta1pb.ResourceId{
		StorageId: parts[0],
		OpaqueId:  parts[1],
	}
}
