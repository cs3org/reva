...
func (s *svc) Register(r mux.Router) {
	r.Route("/overleaf", func(r mux.Router) {
		r.Get("/import", mux.HandlerFunc(s.handleImport))
		r.Post("/export", mux.HandlerFunc(s.handleExport))
	})
}
...
func (s *svc) handleImport(w http.ResponseWriter, r *http.Request, _ mux.Params) {
	reqres.WriteError(w, r, reqres.APIErrorUnimplemented, "Overleaf import not yet supported", nil)
}

func (s *svc) handleExport(w http.ResponseWriter, r *http.Request, _ mux.Params) {
	ctx := r.Context()
