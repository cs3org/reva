...
var _ = Describe("user share provider service", func() {
	...
	Describe("UpdateShare", func() {
		...
		It("succeeds when the tennantId of the user matches the tenantId of the target user", func() {
			statResourceResponse.Info.PermissionSet = &providerpb.ResourcePermissions{
				UpdateGrant:          true,
				InitiateFileDownload: true,
				Stat:                 true,
			...
			getShareResponse.Grantee = &providerpb.Grantee{
				Type: providerpb.GranteeType_GRANTEE_TYPE_USER,
				Id:   &providerpb.Grantee_UserId{UserId: alice.GetId()},
			}
		...
		It("fails when the tennantId of the user does not matche the tenantId of the target user", func() {
			statResourceResponse.Info.PermissionSet = &providerpb.ResourcePermissions{
				UpdateGrant:          true,
				InitiateFileDownload: true,
				Stat:                 true,
