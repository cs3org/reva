...
// SharesProviderClient is an autogenerated mock type for the SharesProviderClient type
type SharesProviderClient struct {
	mock.Mock
}

// ListReceivedShares provides a mock function with given fields: ctx, req, opts
func (_m *SharesProviderClient) ListReceivedShares(ctx context.Context, req *collaborationv1beta1.ListReceivedSharesRequest, opts ...grpc.CallOption) (*collaborationv1beta1.ListReceivedSharesResponse, error) {
...
// UpdateReceivedShare provides a mock function with given fields: ctx, req, opts
func (_m *SharesProviderClient) UpdateReceivedShare(ctx context.Context, req *collaborationv1beta1.UpdateReceivedShareRequest, opts ...grpc.CallOption) (*collaborationv1beta1.UpdateReceivedShareResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
