...
require (
	...
	github.com/gdexlab/go-render v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/gdexlab/go-render => github.com/luci/go-render v0.0.0-20160219211803-9a04cc21af0f
