                ...
                "steps": [
                    ...
                    cloneOCISTestReposStep(),
                    {
                        ...
                        "environment": {
                            ...
                            "TEST_REVA": "true",
                            "SEND_SCENARIO_LINE_REFERENCES": "true",
                            "BEHAT_FILTER_TAGS": "~@toImplementOnOCIS&&~@skipOnOcis-OCIS-Storage&&~@skipOnOcis&&~@skipOnReva&&~@skipOnLDAP&&~@skipOnGraph&&~@provisioning_api-app-required",
                            "DIVIDE_INTO_NUM_PARTS": parallelRuns,
                            "RUN_PART": runPart,
                            "PATH_TO_CORE": "/drone/src/tmp/oc10testrunner",
                            "TEST_WITH_GRAPH_API": "true",
                            "PATH_TO_OCIS": "/drone/src/tmp/ocistestrunner",
