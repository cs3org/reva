...
func main() {
	...
	if err := os.MkdirAll(fmt.Sprintf("changelog/%s", *version), 0755); err != nil {
...
`, *version, *version, *version, date)
	...
	if err := os.WriteFile(fmt.Sprintf("changelog/%s/_index.md", *version), []byte(releaseDocs), 0644); err != nil {
